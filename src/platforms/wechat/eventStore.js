...
判断规则（宽松识别，口语化邀约也算）：
- 明确发起或邀请：「晚上去喝一杯吗」「周六爬山有人去吗」「一起吃饭啊」「大家出来玩」都算
- 有人报名加入：「算我一个」「我要去」「带我」都算更新已有活动
- 提供车位：「我开车」「还有3个位置」「从虹桥出发」都算补充
- 纯闲聊、吐槽、问题、表情、不涉及出行的内容不算
- 特别注意：口语里说的「今晚」「今天下午」「周六」「下周」都要换算成具体日期
...
返回 JSON，不是活动信息就返回 {"isEvent": false}：
{
  ...
  "event": {
    "title": "",           // 简短标题，如"晚上喝哈皮熊"、"周六爬山"、"帮老王搬家"
    "type": "",            // 从已知类型选，或自己填新类型
    "date": "",            // YYYY-MM-DD，"今晚"="今天"，"周六"请推算
    "time": "",            // 出发/开始时间，口语里有提到就填
    "location": "",        // 目的地或活动地点，店名/山名都算
    "meetingPoint": "",    // 集合地点
    "participants": [],    // 参与人昵称，发起人也算进去
